import type { RenownCredentialManagerOperations } from "document-models/renown-credential/v1";
import { AlreadyRevokedError } from "../../gen/manager/error.js";

export const renownCredentialManagerOperations: RenownCredentialManagerOperations =
  {
    initOperation(state, action) {
